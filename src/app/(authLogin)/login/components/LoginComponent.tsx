      ...
      <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
        ...
        <div className="mt-8">
          ...
          <div className="mt-8 flex justify-between items-center">
            ...
            <button className="font-medium text-base text-slate-800">
          ...
          <div className="mt-8 flex justify-center items-center">
            <p className="font-medium text-base">¿Aun no tienes una cuenta?</p>
            <button className="text-slate-800 text-base font-medium ml-2">Registrate</button>
          </div>
        </div>
      </div>
    </>
